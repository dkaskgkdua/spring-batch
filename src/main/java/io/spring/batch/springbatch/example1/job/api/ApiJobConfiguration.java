...
import io.spring.batch.springbatch.example1.listener.JobCustomListener;
import io.spring.batch.springbatch.example1.tasklet.ApiEndTasklet;
import io.spring.batch.springbatch.example1.tasklet.ApiStartTasklet;
...
public class ApiJobConfiguration {
    ...
    public Job apiJob() {
        return jobBuilderFactory.get("apiJob")
                .listener(new JobCustomListener())
                .start(apiStep1())
                .next(jobStep)
                .next(apiStep2())
                .build();
